...
import Data,Signup, Visualization
...
ap = st.sidebar.selectbox(
            ...
            options=['Data','Signup','Visualization']
        )
...
if ap == 'Data':
    ...
    def main():
        ...
        if choice == "Home":
            st.subheader("Welcome to Crime-Pred")
            ...
            if new_user is None:st.write("please enter user user")
        if st.button("Signup"):
                create_usertable()
